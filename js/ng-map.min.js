angular.module("ngMap", []),
    function() {
        ...
        var e, t = function(t, n, o, i, r, a, s) {
            e = r;
            var p = this;
            p.mapOptions, p.mapEvents, p.addObject = function(e, t) {
                if (p.map) {
                    p.map[e] = p.map[e] || {};
                ...
                p.map.setOptions(r);
                for (var O in u) google.maps.event.addListener(p.map, O, u[O]);
                p.observeAttrSetObj(c, o, p.map), p.singleInfoWindow = r.singleInfoWindow, google.maps.event.addListenerOnce(p.map, "idle", function() {
            ...
            var c = e.orgAttributes(n),
                ...
                f = e.getEvents(t, u);
            Object.keys(f).length && void 0, p.mapOptions = d, p.mapEvents = f, l.lazyInit ? (p.map = {
                id: o.id
                ...
                return function(a, s, p, c) {
                    ...
                    t(function() {
                        a.$watch("[" + r.join(",") + "]", function() {
                            f.setContent(n, a)
                        }), f.setContent(s[0].innerHTML, a);
                        var e = s[0].firstElementChild.className;
                        f.addClass("custom-marker"), f.addClass(e), g.position instanceof google.maps.LatLng || o.getGeoLocation(g.position).then(function(e) {
                            f.setPosition(e)
                        })
                    });
                    for (var m in d) google.maps.event.addDomListener(f.el, m, d[m]);
                    c.addObject("customMarkers", f), c.observeAttrSetObj(u, p, f), s.bind("$destroy", function() {
                        c.deleteObject("customMarkers", f)
                    })
                }
            },
            s = function(i, s, p, c) {
    ...
    function() {
        ...
        var e, t, n = [],
            o = function(o) {
                ...
                i.style.width = "100%", i.style.height = "100%", o.appendChild(i);
        ...
        s.$inject = ["$document", "$window"], angular.module("ngMap").factory("NgMapPool", s)
    }(),
    function() {
        "use strict";
        var e, t, n, o, i, r, a, s = {},
            ...
            g = function(e) {
                var t = Object.keys(s).length - 1,
                    n = e.map.id || t;
                "undefined" != typeof e.map.controls && e.map.controls.forEach(function(e) {
                    e.clear()
                }), delete s[n]
            },
            d = function(e, t) {
        ...
        angular.module("ngMap").provider("NgMap", function() {
            ...
            var p = function(p, v, y, h, M, O, b) {
                return e = p, t = v[0], n = y, o = h, i = M, r = O, a = b, {
                    defaultOptions: s,
                    addMap: l,
                    deleteMap: g,
                    getMap: u,
